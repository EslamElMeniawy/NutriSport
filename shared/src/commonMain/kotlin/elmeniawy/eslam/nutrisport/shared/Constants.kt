...
object Constants {
    ...
    val PAYPAL_AUTH_KEY = "${BuildKonfig.PAYPAL_CLIENT_ID}:${BuildKonfig.PAYPAL_SECRET_ID}"
    ...
    const val RETURN_URL = "elmeniawy.eslam.nutrisport://paypalpay?success=true"
    const val CANCEL_URL = "elmeniawy.eslam.nutrisport://paypalpay?cancel=true"
